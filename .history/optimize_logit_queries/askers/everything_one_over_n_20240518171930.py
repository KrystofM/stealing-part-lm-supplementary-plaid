...
def test_calculute_products():
    ...
    print('Simple product d vectorized:', simple_product_d_vectorized)
    simple_product_d_vectorized = calculate_product_d_vectorized(simple_intervals[0][0], simple_intervals[0][1], 0.5, simple_intervals, simple_mu, simple_sigma, new_r, 0)
    print('Simple product d vectorized:', simple_product_d_vectorized)
