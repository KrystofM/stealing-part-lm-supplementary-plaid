...
def system_of_equations(r_values, intervals, mu, sigma, n):
    ...
    for i in range(1, len(intervals)):
        ...
        equations.append(product - first_product)
        last_product = product
    
    if last_product is not None:
        equations.append(first_product - last_product)
...
# Solve for r_values
r_values = least_squares(system_of_equations, initial_guess, args=(intervals, mean, std, N), method='trf').x
