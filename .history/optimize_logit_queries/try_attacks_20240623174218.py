...
if DATA_SOURCE == "random_uniform":
    ...
    reals = [np.random.normal(0.621457, 0.0497, size=NTOK) for _ in range(N_TRIALS)]
else:
...
for real in reals:
    ...
    # # )
    # results.append(run_attack(real, tolerance, error_type, "normal_perfect","bellman_ford", precision=1e-7))
