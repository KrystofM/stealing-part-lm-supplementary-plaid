...
adjusted_samples = samples + np.array(r_values)[:, None]
# Check the proportion of time each random variable is higher than 1
proportions_higher_than_1 = np.mean(adjusted_samples > 1, axis=1)

# Print the proportions
for i, proportion in enumerate(proportions_higher_than_1):
    print(f"Proportion of time interval {i} is higher than 1: {proportion}")
