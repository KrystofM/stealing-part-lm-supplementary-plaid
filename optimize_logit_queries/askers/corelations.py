...
def compute_correlations(mean1, std1, lower1, upper1, mean2, std2, lower2, upper2, size=1000):
...
# Example usage
mean1, std1, lower1, upper1 = 0.5, 0.1, 0.8, 1
mean2, std2, lower2, upper2 = 0.5, 0.1, 0.59, 0.6
